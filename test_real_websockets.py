...
async def test_notification_websocket():
    ...
    login_response = requests.post(
        "https://medconnect-live-1.preview.emergentagent.com/api/login",
...
async def test_video_call_websocket():
    ...
    appointment_response = requests.post(
        "https://medconnect-live-1.preview.emergentagent.com/api/appointments",
    ...
    video_call_response = requests.post(
        f"https://medconnect-live-1.preview.emergentagent.com/api/video-call/start/{appointment_id}",
